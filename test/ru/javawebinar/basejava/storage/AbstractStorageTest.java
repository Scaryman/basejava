...
public abstract class AbstractStorageTest {
    ...
    public void getAll() {
        ...
        Assert.assertTrue(Arrays.asList(result).contains(R1));
        Assert.assertTrue(Arrays.asList(result).contains(R2));
        Assert.assertTrue(Arrays.asList(result).contains(R3));
    }
